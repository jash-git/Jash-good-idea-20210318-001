...
try{
for(var m,i=e[Symbol.iterator]();!(r=(m=i.next()).done)&&(n.push(m.value),!t||n.length!==t);r=!0);
}catch(s){
o=!0,a=s;
}finally{
try{
...
define("pages_new/modules/comment/comment_store.js",["pages_new/3rd/vue.js","common/keyboard.js","common/utils.js","biz_wap/utils/device.js","biz_wap/utils/mmversion.js","biz_wap/utils/jsmonitor_report.js"],function(e){
"use strict";
var t=e("pages_new/3rd/vue.js"),n=e("common/keyboard.js"),r=e("common/utils.js"),o=e("biz_wap/utils/device.js"),a=e("biz_wap/utils/mmversion.js"),m=e("biz_wap/utils/jsmonitor_report.js"),i="http://mmbiz.qpic.cn/mmbiz/a5icZrUmbV8p5jb6RZ8aYfjfS2AVle8URwBt8QIu6XbGewB9wiaWYWkPwq4R7pfdsFibuLkic16UcxDSNYtB8HnC1Q/0";
return{
name:"mp-comment",
namespaced:!0,
state:function(){
...
return a.isWechat?o.os.ipad?0:a.isInMiniProgram?0:n.canUseKeyboard?2:(a.isIOS||a.isAndroid)&&(a.gtVersion("7.0.8")||r.isNativePage())?1:0:0;
}(),
offset:0,
replyFlag:0,
warningToast:"",
...
var n=t.type,r=void 0===n?"mine":n,o=t.commentIdx,a=t.replyIdx,m=t.likeStatus,i="mine"===r?e.myCommentData.my_comment:e.commentData.elected_comment;
if("number"==typeof o&&"undefined"==typeof a){
var s=i[o];
s&&s.like_status!==m&&(s.like_status=m,s.like_num+=m?1:-1);
}else if("number"==typeof o&&"number"==typeof a){
var s=i[o],u=s.reply_new.reply_list[a];
u&&u.reply_like_status!==m&&(u.reply_like_status=m,u.reply_like_num+=m?1:-1,s.reply_new=_extends({},s.reply_new));
}
},
addComment:function(e,n){
var r=n.type,o=void 0===r?"mine":r,a=n.commentItem,m=n.commentIdx,i=n.replyItem,s=n.replyIdx,u="mine"===o?e.myCommentData.my_comment:e.commentData.elected_comment;
if("undefined"!=typeof a)u.unshift(a);else if("number"==typeof m&&"undefined"!=typeof i){
var c=u[m];
c&&(c.reply_new?("number"==typeof s?c.reply_new.reply_list.splice(s+1,0,i):c.reply_new.reply_list.push(i),
...
var n=t.type,r=void 0===n?"mine":n,o=t.commentIdx,a=t.replyIdx,m="mine"===r?e.myCommentData.my_comment:e.commentData.elected_comment;
if("number"==typeof o&&"undefined"==typeof a)m.splice(o,1);else if("number"==typeof o&&"number"==typeof a){
var i=m[o];
i&&(i.reply_new.reply_list.splice(a,1),i.reply_new.reply_total_cnt--,i.reply_new=_extends({},i.reply_new));
}
},
updateCommentReplyInfo:function(e,t){
var n=t.commentIdx,r=t.key,o=t.value;
if("number"==typeof n){
var a=e.commentData.elected_comment[n];
a&&a.reply_new&&r in a.reply_new&&(a.reply_new[r]=o,a.reply_new=_extends({},a.reply_new));
}
},
...
function d(e,n){
E&&n&&!G[n]&&_({
url:e.replace(/#.*$/,"")+"&action=preload",
type:"GET",
timeout:2e3,
success:function(i){
try{
G[n]=JSON.parse(i),console.info("[Lifecycle Manager] Preload PageData",n,e,G[n]),
w.info("[Lifecycle Manager] Preload PageData",n,e);
}catch(o){
console.error("[Lifecycle Manager] Parse Preload PageData Failed",n,e,o),w.error("[Lifecycle Manager] Parse Preload PageData Failed",n,e,o.toString());
}
...
var a=_extends({},j.getParams(location.href),j.getParams(e)),t=3e3,r=2,g=0,d=null;
s();
var u=function(){
if(g===r)if(d&&d.base_resp&&0===d.base_resp.ret){
G={};
var n=j.getParams(location.href);
f(d,n),c(),I=!1,o(30),console.info("[Lifecycle Manager] Finish to switch to",e),
w.info("[Lifecycle Manager] Finish to switch to",e);
}else y.loadNewPageKeepingHistoryStackIfSecOpen(e);
},h=setTimeout(function(){
o(32),location.href===e?location.reload():y.loadNewPageKeepingHistoryStackIfSecOpen(e);
},t),v=function M(n){
...
clearTimeout(h),k.isIOS&&(window.__second_open__=D),p(e),g++,u();
};
...
w.info("[Lifecycle Manager] Get Cache PageData",n),d=G[n],f(d,a),l(d),g++,u()):_({
url:e.replace(/#.*$/,"")+"&action=preload",
type:"GET",
async:!1,
timeout:2e3,
success:function(n){
try{
d=JSON.parse(n),console.info("[Lifecycle Manager] Get PageData",d),w.info("[Lifecycle Manager] Get PageData");
}catch(i){
console.error("[Lifecycle Manager] Parse PageData Failed",e,i),w.error("[Lifecycle Manager] Parse PageData Failed",e,i.toString());
}
d&&(f(d,a),l(d)),g++,u();
},
error:function(){
